...
export default function AboutUs() {
    ...
    return (
        <>
            ...
            <UnisonHistorySlider/>
            <div className="mobileYearlyReports bg-light d-flex flex-wrap justify-content-center d-md-none rounded-3 mx-3 border border-dark">
                    <h3 className="text-primary">წლიური ანგარიშები</h3>
                    <Form.Select name="yearly-report" className="w-50">
